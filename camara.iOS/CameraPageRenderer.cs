...
[assembly: ExportRenderer(typeof(camara.CameraPage), typeof(CameraPageRenderer))]
namespace camara.iOS
{
    public class CameraPageRenderer : PageRenderer
    {
        ...
        private void SetupEventHandlers()
        {
            ...
            {
                (Element as camara.CameraPage).Cancel();
            };
            ...
            takePhotoButton.TouchUpInside += async (s, e) =>
            {
                ...
                (Element as camara.CameraPage).SetPhotoResult(data.ToArray(),
